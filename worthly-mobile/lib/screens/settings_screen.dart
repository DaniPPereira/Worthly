...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final activeDevices = _devices.where((item) => !item.revoked).toList();
    ...
    return ListView(
      ...
      children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Last seen ${Period.instant(device.lastSeenAt, owner?.reportingTimezone ?? 'UTC')}',
        ...
        _group('Data', [
          ListTile(
            title: const Text('Connections', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 13.5)),
            subtitle: const Text('Banks and brokerages', style: TextStyle(fontSize: 11.5)),
            trailing: const Icon(Icons.chevron_right, color: WorthlyColors.faint),
            onTap: () {
