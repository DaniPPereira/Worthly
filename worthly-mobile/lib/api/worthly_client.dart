...
List<CategorizationRule> parseCategorizationRules(dynamic json) => listOf(json, CategorizationRule.fromJson);
CategorizationRule parseCategorizationRule(dynamic json) => CategorizationRule.fromJson(json as Map<String, dynamic>);
Category parseCategory(dynamic json) => Category.fromJson(json as Map<String, dynamic>);
